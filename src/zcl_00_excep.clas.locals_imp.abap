...
*      RAISE EXCEPTION TYPE cx_abap_invalid_value.
        RAISE EXCEPTION TYPE zcx_00_failed
        EXPORTING
...
*        DATA(days_later) =  i_from_date - flight->flight_date.
    ...
    ENDLOOP.
  ENDMETHOD.
"! Search for a <strong>passenger flight</strong> between two airports that"! <ul>
"! "! <li>lies on or after a given date and</li>
"! "! <li>has a minimum number of available seats left</li>
"! "!</ul>"! @parameter i_airport_from_id |
"! "! @parameter i_airport_to_id |
"! "! @parameter i_from_date |"! @parameter i_seats |
"! "! @parameter e_flight |"! @parameter e_days_later |
